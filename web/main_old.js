+function($) {
    ...
    q.data = {
        ...
        placeholder_productsCount: $('.block__cart > .field > p'),
        placeholder_totalCost: $('.block__cart > .field > .total-cost'),
        placeholder_content: $('.block__content'),
        // buttons_page: $.querySelectorAll('.block__menu > li > a'),
        buttons_page: $('.links_pages a'),
        buttons_product: $('.block__categories > ul > li > a'),
        // buttons_addToCart: $.querySelectorAll('.field_add-button'),
        button_home: $('.block__brand > a'),
        button_cart: $('.block__cart'),
        button_search: $('.block__search > input[type=submit]'),
        value_search: $('.block__search > input[type=search]'),
